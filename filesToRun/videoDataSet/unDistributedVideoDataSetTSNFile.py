...
#base_config_dir = os.path.join(project_path, "mmaction2", "configs", "_base_")
#_base_ = [
#    os.path.join(base_config_dir, "models", "tsn_r50.py"),
#    os.path.join(base_config_dir, "schedules", "sgd_100e.py"),
#    os.path.join(base_config_dir, "default_runtime.py")
#
_base_ = [
...
val_dir = data_directory

ann_file_train = os.path.join(project_path, "mmaction2", "DataSet", "annotation.txt")
